                        ...
                        <?php while ($rowClientes = mysqli_fetch_assoc($query)) { ?>
                            <tr>
                                <td style="min-width:150px">
                                    ...
                                    <a href="ingresos.php?id_eliminar=<?= $rowClientes['id'] ?>&id_proyecto=<?= urlencode($idProyectoEncriptado) ?>"
                                        class="btn-sm btn btn-danger delete-record" data-id="<?= $rowClientes['id'] ?>">
