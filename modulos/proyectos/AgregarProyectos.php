...
$titulo = "Agregar planilla empleados";
include('../../template/top.php');
?>

<div class="row text-right">
    <div class="col-12">
        <a href="empleados.php" class="btn btn-primary animate__animated animate__zoomIn"><i class="fas fa-fw fa-arrow-left"></i> Regresar</a>
    </div>
</div>
...
<div class="row">
    ...
    <?php 
        $sqlEditar = "SELECT * FROM templeados WHERE identificacion = '$idEditar'";
