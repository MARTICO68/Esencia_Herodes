...
if (isset($_POST['guardar'])) {
    ...
    $sqlClientes = "INSERT INTO tproyectos (nombre, descripcion, fechaini, fechafin, estado) VALUES ('$nombre', '$descripcion', '$fechaini', '$fechafin', 1)";
    $queryClientes = mysqli_query($conn, $sqlClientes);

    if ($queryClientes) {
        $message = 'El proyecto fue guardado exitosamente.';
        $script = "Swal.fire('Éxito', '$message', 'success').then((result) => {document.location.href = 'proyectos.php';});";
    } else {
        $message = 'Hubo un error al guardar el proyecto.';
        $script = "Swal.fire('Error', '$message', 'error');";
    }
        ...
        <div class="col-12 col-md-6">
            <form class="user" action="" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <label for="fechafin" class="animate__animated animate__slideInLeft"><i class="fas fa-fw fa-phone animate__animated animate__slideInLeft"></i> Fecha de finalización: </label>
